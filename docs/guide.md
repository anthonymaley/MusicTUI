...
|-------|--------------|-------------|
| **No auth** | Just install the plugin | Playback, speakers, volume, now playing, shuffle, repeat, radio favorites (list/play/add by URL), Library tab (artists, albums, songs) |
